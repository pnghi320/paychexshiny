...
#data = pd.read_csv(r"C:\Users\Tyler\Desktop\Newfolder2\PayChex\Data\PayChex_Data_convTimstamp_Date123.csv", 
#                 parse_dates={'dt' : ['dates']}, infer_datetime_format=True, 
#                 low_memory=False, na_values=['nan','?'], index_col='dt')
...
#Writing to pickle file for Dharma
#pickle.dump( stats_dict_to_store_for_display_use_this, open( "stats_dict.p", "wb" ) )
#Reading from pickle file for Dharma
#stats_dict_to_store_for_display_use_this = pickle.load( open( "stats_dict.p", "rb" ) )
